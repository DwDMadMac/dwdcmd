package net.downwithdestruction.dwdcmd.nms;

/**
 * Created by madmac on 11/23/15.
 * <p>
 * Don't need nms for books, using this for future references
 */

public class BookItem {
/*

    private net.minecraft.server.v1_8_R3.ItemStack item = null;
